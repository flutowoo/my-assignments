...
import com.fluto.myassignment.databinding.ItemAddUserBinding
...
class AddUserAdapter(
...
) : ListAdapter<User, AddUserAdapter.SelectUserListViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = SelectUserListViewHolder(
        ItemAddUserBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
    ...
    inner class SelectUserListViewHolder(private val binding: ItemAddUserBinding) :
